    ...
    <div className="border border-gray-200 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-900 shadow-sm overflow-x-auto">
      <div className="min-w-[900px]">
        ...
        <div className="flex border-b border-gray-200 dark:border-gray-700 bg-gray-50/80 dark:bg-gray-800/60 sticky top-0 z-10">
          <div className={`${EMPLOYEE_COL_WIDTH} flex-shrink-0 py-2.5 sticky left-0 bg-gray-50/80 dark:bg-gray-800/60 z-20 border-r border-gray-200 dark:border-gray-700/80`}>
        ...
        {employees.map((emp) => {
          ...
          return (
            ...
            >
              <div className={`${EMPLOYEE_COL_WIDTH} flex-shrink-0 py-2.5 sticky left-0 z-10 border-r border-gray-200 dark:border-gray-700/80 transition-colors ${
                ...
                <div className="flex items-center px-4">
                  ...
                  <Link
                    to={`/employee/${emp.id}`}
                    className="block min-w-0 text-[13px] font-medium text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 truncate transition-colors"
                    title={emp.name}
                  >
                    {shortName(emp.name)}
                  </Link>
